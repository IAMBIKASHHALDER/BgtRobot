...
EnglishStrings = {
    "send-start": """Hi {}, my name {}! If you have any questions on how to use me, read /help - and then head to @Bgt_Chat.

I'm a group manager bot maintained by [this person](tg://user?id={1439222689}). I'm a [Bikash](https://t.me/bikashbikash)
I'm built in python3, using the \
python-telegram-bot library, and am fully opensource - you can find what makes me tick\
[here](https://t.me/Adityaserver))!

Feel free to submit pull requests on github, or to contact my support group, @AdityaDiscus @Bgt_Chat, with any bugs, questions \
