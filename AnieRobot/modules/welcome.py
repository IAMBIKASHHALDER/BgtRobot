...
import BgtRobot.modules.sql.welcome_sql as sql
from BgtRobot import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP
from BgtRobot.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from BgtRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from BgtRobot.modules.helper_funcs.msg_types import get_welcome_type
...
from BgtRobot.modules.feds import welcome_fed
...
def new_member(update, context):
    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == 1656343543:
                bot.send_message(chat.id, "Yo,Sir Bgt Owner is just joined this group😎")
                continue
