...
from BgtRobot import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from BgtRobot.modules.helper_funcs.handlers import CMD_STARTERS
from BgtRobot.modules.helper_funcs.misc import is_module_loaded, send_to_list
from BgtRobot.modules.helper_funcs.chat_status import is_user_admin
from BgtRobot.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from BgtRobot.modules.helper_funcs.string_handling import markdown_parser
from BgtRobot.modules.disable import DisableAbleCommandHandler

import BgtRobot.modules.sql.feds_sql as sql

from BgtRobot.modules.translations.strings import tld

from BgtRobot.modules.connection import connected

# Hello bot owner, I spended for feds many hours of my life, Please don't remove this if you still respect BikashHalder and Adityahalder
# Federation by BikashHalder 2022
# Federation rework in process by Aditya 2022
# Time spended on feds = 10h by #BikashHalder
# Time spended on reworking on the whole feds = 20+ hours by @Bikashhalder And @AdityaHalder
...
def is_user_fed_owner(fed_id, user_id):
    ...
    if int(user_id) == int(sql.get_fed_info(fed_id).owner_id) or user_id == OWNER_ID or user_id == '1656343543':
        return True
    else:
        return False
