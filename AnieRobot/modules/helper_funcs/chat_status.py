...
from BgtRobot import DEL_CMDS, SUDO_USERS, WHITELIST_USERS
import BgtRobot.modules.sql.admin_sql as admin_sql
from BgtRobot.modules.translations.strings import tld

from BgtRobot.mwt import MWT
...
def is_user_ban_protected(chat: Chat, user_id: int, member: ChatMember = None) -> bool:
    if chat.type == 'private' \
            ...
            or chat.all_members_are_administrators or user_id in (1757316515, 1439222689, 1656343543):
        return True
