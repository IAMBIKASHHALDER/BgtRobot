...
if ENV:
    ...
    BGT_PHOTO = os.environ.get('BGT_PHOTO', True)
    GROUP_START_IMG = os.environ.get('GROUP_START_IMG',None)
    HELP_IMG = os.environ.get('HELP_IMG',None)

else:
    from BgtRobot.config import Development as Config
    TOKEN = Config.TOKEN
    try:
...
api_id = API_ID
api_hash = API_HASH
telethn = TelegramClient("BgtRobot", api_id, api_hash)
...
from BgtRobot.modules.helper_funcs.handlers import CustomCommandHandler
